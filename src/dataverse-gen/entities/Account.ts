...
export const enum AccountAttributes {
  ...
  axz_CarBrandText = "axz_carbrandtext",
  axz_CarSubbrandText = "axz_carsubbrandtext",
...
export interface Account extends IEntity {
  ...
  // Car Brand Text MemoType
  axz_carbrandtext?: string | null;
  // Car Subbrand Text MemoType
  axz_carsubbrandtext?: string | null;
